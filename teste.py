...
def count():
    ...
    if not given_name.strip():
        ...
        no_text.grid(row=0, column=0, columnspan=3, pady=2)
...
counter_name = ctk.CTkEntry(window,
                            ...
                            width=200,
                            height=50)
counter_name.grid(row=1, column=0, columnspan=3, pady=30)
...
title_place = ctk.CTkScrollableFrame(window,
                                      ...
                                      border_color='black')
title_place.grid(row=3, column=0, padx=40, pady=5)

# Separation Frame 2
time_place = ctk.CTkScrollableFrame(window,
                                     width=370, height=370,
                                     border_color='black')
time_place.grid(row=3, column=1, padx=20, pady=5)
